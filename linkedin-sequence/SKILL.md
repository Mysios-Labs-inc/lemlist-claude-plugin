...
description: >
  ...
  product, any seniority level. Always produces a complete 2-message LinkedIn sequence
  calibrated for the platform's conversational context and character constraints.
---
...
| Format | Limit | Notes |
|---|---|---|
| Connection note | 300 characters | Optional — often better without |
| DM (standard) | No hard limit | Self-limit to 40–70 words for performance |
