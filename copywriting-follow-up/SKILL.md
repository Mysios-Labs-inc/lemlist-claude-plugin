...
Before writing, pick the new angle from `references/angle-bank.md` (pain,
stakeholder, timing, risk, and resource angles). Never repeat an angle already
used in a previous email in the sequence.
